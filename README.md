...
|3. Vocabulary review (With Scribuddies)|Students' vocabulary selection + teacher's prepared vocabulary collection<br>⤿ 20 words are drawn, and a telestration is performed based on those words<br><br>**3.1. Word draw**<br>Teacher selects words from the text in advance<br>⤿ Collect students' opinions (difficult words, memorable words, etc.)<br>⤿ Students select vocabulary words + Teacher takes a collection of words and enters them into a code to draw words.<br>→ 20 or so words are drawn, and the telestation begins.<br><br>**3.2. Scribuddies 1** (Teacher → Student)<br>Teacher demonstrates, students participate.<br>Pick a word and set a timer for 30 seconds to 1 minute<br>→ Teacher starts drawing a picture on the shared screen and students start guessing.<br>At the end of 30 seconds, have everyone answer together.<br><br>**3.3. Scribuddies 2** (Pair)<br>2 people or group (2 people is preferred)<br>+Teacher encourages quick progress with a 30-second limit|
|4. Grammar Review (subjective questions)|Review the 'grammar' that students learned in the last chapter.<br>ㆍRelative pronouns<br>ㆍParticiple phrases<br>Blank sentences in the text and outside passages with important grammar.|
...
|Process|Content|
|--|--|
|1. Watch the video- 5 min|1.1 Introduce the video to the students. <br> [🎬**Video Link**](https://youtu.be/0kFjS6w_AQQ) <br> <br> 1.2 Briefly summarize the content of the video. <br> <Br> 1.3 Ask the students questions and encourage a discussion. <br> ❕|
|2. Content Review (With *Multiple Choice*)- 10 min|2.1 Introduce the online questions to check understanding. <br> <br> 2.2 Conduct online questions. <br> [☀️**Content Quiz**](Link) <br> <br> 2.3 Ask the students have questions.<br> ❕ |
|3. Vocabulary review (With **Scribuddies**)- 20 min|3.1  Introduce the new vocabulary learning app and explain the activity. <br> [🌈**Scribuddies**](886d51e09355dfb85e.gradio.live) <br> <br> 3.2 Teacher demonstrates the app with a student. <br> <br> 3.3 Pair up the students. <br> **3.3.1. Word draw** <br>Teacher selects words from the text in advance<br>⤿ Collect students' opinions (difficult words, memorable words, etc.)<br>⤿ Students select vocabulary words + Teacher takes a collection of words and enters them into a code to draw words.<br>→ 20 or so words are drawn, and the telestation begins.<br> <br>**3.3.2. Scribuddies** (Teacher → Student)<br>Teacher demonstrates, students participate.<br>Pick a word and set a timer for 30 seconds to 1 minute<br>→ Teacher starts drawing a picture on the shared screen and students start guessing.<br>At the end of 30 seconds, have everyone answer together.<br><br>**3.3.3. Scribuddies 2** (Pair)<br>2 people or group (2 people is preferred)<br>+Teacher encourages quick progress with a 30-second limit<br> <br> 3.4 Inform students to ask for help if needed. <br> <br> 3.5 Teacher monitors the students' activities and provides support as needed. <br> ❕ |
|4. Grammar Review (With *subjective questions*)- 10 min|4.1 Wrap up the vocabulary learning activity and introduce the next activity. <br> <br> 4.2 Introduce the new grammar understanding activity. <br> <br> 4.3 Explain how to use the app and the activity process. <br> [🐾**Grammar Quiz**](Link) <br> <br> 4.4 Have time solving questions. <br> <br> 4.5 After students finish the questions, go through the solutions together. <br> <br> 4.6 Take questions from students and explain any unclear points. <br> ❕ |
|5. Finalize- 5 min|5.1 Wrap up the grammar understanding activity. <br> <br> 5.2 Briefly summarize the story learned today. <br> <br> 5.3 Review the vocabulary and grammar learned in the activities. <br> <br> 5.4 Inform students about the next lesson. <br> <br> 5.5 Take questions from students and conclude the lesson. <br> ❕ |
